...
struct KawaiiUiProfile {
    ...
    static constexpr bool kShowMascots = uiFeatureValue(UI_FEATURE_MASCOTS, true);
    static constexpr bool kShowPatternBackground =
        uiFeatureValue(UI_FEATURE_PATTERN_BACKGROUND, true);
};
