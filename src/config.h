...
// RICOH GR IIIx handles copied from the hardware-verified reference project.
// GR IIIx opens its AP through Network Type (0x00F0) and does not expose the
// GR IV security/frequency/BSSID attributes. The channel attribute exists but
// is not consumed by the current Wi-Fi credential parser.
constexpr uint16_t RICOH_BLE_GR3X_WLAN_POWER_HANDLE = 0x00F0;
constexpr uint8_t RICOH_BLE_GR3X_WLAN_ON_VALUE = 0x01;
constexpr uint16_t RICOH_BLE_GR3X_WLAN_SSID_HANDLE = 0x00F3;
constexpr uint16_t RICOH_BLE_GR3X_WLAN_PASSPHRASE_HANDLE = 0x00F5;
constexpr uint16_t RICOH_BLE_GR3X_WLAN_SECURITY_HANDLE = 0;
constexpr uint16_t RICOH_BLE_GR3X_WLAN_FREQUENCY_HANDLE = 0;
constexpr uint16_t RICOH_BLE_GR3X_WLAN_CHANNEL_HANDLE = 0x00F7;
constexpr uint16_t RICOH_BLE_GR3X_WLAN_BSSID_HANDLE = 0;
constexpr uint16_t RICOH_BLE_GR3X_POWER_STATE_HANDLE = 0x00BC;
constexpr uint16_t RICOH_BLE_GR3X_POWER_STATE_CCCD_HANDLE = 0x00BD;
constexpr uint8_t RICOH_BLE_GR3X_POWER_STATE_ON_VALUE = 0x01;
constexpr uint8_t RICOH_BLE_GR3X_POWER_STATE_OFF_VALUE = 0x00;

// Compile-time model selection. The default environment resolves to exactly the
// original GR IV constants; m5stack-sticks3-gr3x selects only the IIIx handles.
#ifdef CAMERA_MODEL_GR3X
constexpr uint16_t RICOH_BLE_WLAN_POWER_HANDLE = RICOH_BLE_GR3X_WLAN_POWER_HANDLE;
constexpr uint8_t RICOH_BLE_WLAN_ON_VALUE = RICOH_BLE_GR3X_WLAN_ON_VALUE;
constexpr uint16_t RICOH_BLE_WLAN_SSID_HANDLE = RICOH_BLE_GR3X_WLAN_SSID_HANDLE;
constexpr uint16_t RICOH_BLE_WLAN_PASSPHRASE_HANDLE = RICOH_BLE_GR3X_WLAN_PASSPHRASE_HANDLE;
constexpr uint16_t RICOH_BLE_WLAN_SECURITY_HANDLE = RICOH_BLE_GR3X_WLAN_SECURITY_HANDLE;
constexpr uint16_t RICOH_BLE_WLAN_FREQUENCY_HANDLE = RICOH_BLE_GR3X_WLAN_FREQUENCY_HANDLE;
constexpr uint16_t RICOH_BLE_WLAN_BSSID_HANDLE = RICOH_BLE_GR3X_WLAN_BSSID_HANDLE;
constexpr uint16_t RICOH_BLE_POWER_STATE_HANDLE = RICOH_BLE_GR3X_POWER_STATE_HANDLE;
constexpr uint16_t RICOH_BLE_POWER_STATE_CCCD_HANDLE = RICOH_BLE_GR3X_POWER_STATE_CCCD_HANDLE;
constexpr uint8_t RICOH_BLE_POWER_STATE_ON_VALUE = RICOH_BLE_GR3X_POWER_STATE_ON_VALUE;
constexpr uint8_t RICOH_BLE_POWER_STATE_OFF_VALUE = RICOH_BLE_GR3X_POWER_STATE_OFF_VALUE;
#else
constexpr uint16_t RICOH_BLE_WLAN_POWER_HANDLE = RICOH_BLE_GR4_WLAN_POWER_HANDLE;
constexpr uint8_t RICOH_BLE_WLAN_ON_VALUE = RICOH_BLE_GR4_WLAN_ON_VALUE;
constexpr uint16_t RICOH_BLE_WLAN_SSID_HANDLE = RICOH_BLE_GR4_WLAN_SSID_HANDLE;
constexpr uint16_t RICOH_BLE_WLAN_PASSPHRASE_HANDLE = RICOH_BLE_GR4_WLAN_PASSPHRASE_HANDLE;
constexpr uint16_t RICOH_BLE_WLAN_SECURITY_HANDLE = RICOH_BLE_GR4_WLAN_SECURITY_HANDLE;
constexpr uint16_t RICOH_BLE_WLAN_FREQUENCY_HANDLE = RICOH_BLE_GR4_WLAN_FREQUENCY_HANDLE;
constexpr uint16_t RICOH_BLE_WLAN_BSSID_HANDLE = RICOH_BLE_GR4_WLAN_BSSID_HANDLE;
constexpr uint16_t RICOH_BLE_POWER_STATE_HANDLE = RICOH_BLE_GR4_POWER_STATE_HANDLE;
constexpr uint16_t RICOH_BLE_POWER_STATE_CCCD_HANDLE = RICOH_BLE_GR4_POWER_STATE_CCCD_HANDLE;
constexpr uint8_t RICOH_BLE_POWER_STATE_ON_VALUE = RICOH_BLE_GR4_POWER_STATE_ON_VALUE;
constexpr uint8_t RICOH_BLE_POWER_STATE_OFF_VALUE = RICOH_BLE_GR4_POWER_STATE_OFF_VALUE;
#endif
