...
private:
  bool connectTo(const char* ssid, const char* password, const char* bssid, uint32_t timeoutMs);
  bool connectTo(const char* ssid, const char* password, const char* bssid, uint32_t timeoutMs, ConnectGuard guard);
